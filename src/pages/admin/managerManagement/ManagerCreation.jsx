...
import { createManager } from "src/lib/service/adminService"; // Thêm getBars
...
const AccountForm = () => {
  ...
  const [imageUrl, setImageUrl] = useState(
    "https://cdn.builder.io/api/v1/image/assets/TEMP/d61fbfce841ecc9d25137354a868eca4d9a5b3f3a4e622afcda63d7cca503674"
  );
  ...
  return (
    <main className="flex flex-col px-4 md:px-8 lg:px-16 py-8 w-full max-w-7xl mx-auto">
      <header className="flex items-center justify-between mb-8">
        ...
        <h1 className="font-bold text-center flex-grow">
