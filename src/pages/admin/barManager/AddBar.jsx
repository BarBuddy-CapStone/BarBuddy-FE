...
const TimeSelector = ({ label, isCloseTime }) => {
    ...
    return (
        <div className="flex flex-1 gap-4 items-center">
            <div
                className={`flex gap-3 items-center px-2 py-3 rounded-lg border-2 border-neutral-300 cursor-pointer hover:shadow-lg transition-all ${isActive ? (isCloseTime ? 'w-64' : 'w-56') : 'w-56'}`} // Adjust width based on active state and type
