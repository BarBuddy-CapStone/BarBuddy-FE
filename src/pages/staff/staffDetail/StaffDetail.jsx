    ...
    return (
        <main className="flex flex-col px-4 md:px-8 lg:px-16 py-8 w-full max-w-7xl mx-auto">
            <header className="flex items-center justify-between mb-8">
                ...
                <h1 className="text-3xl font-bold text-center flex-grow">THÔNG TIN TÀI KHOẢN</h1>
            ...
            <div className="flex gap-5 max-md:flex-col">
                <aside className="flex flex-col w-[18%] max-md:ml-0 max-md:w-full">
                    <img
                        ...
                        alt="User profile"
                        className="object-contain shrink-0 mt-3 -mr-8 max-w-full aspect-square w-[216px] max-md:w-full"
                    />
                </aside>
