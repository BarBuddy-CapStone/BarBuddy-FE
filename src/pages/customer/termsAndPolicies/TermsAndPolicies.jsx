...
const TermsAndPolicies = () => {
    ...
    return (
        ...
        >
            ...
            >
                <h1 className="text-4xl font-bold text-orange-500 mb-4">Điều Khoản và Chính Sách</h1>
                <p className="text-gray-400">Vui lòng đọc kỹ các điều khoản trước khi sử dụng dịch vụ</p>
            </motion.div>
            ...
            <div className="grid gap-8">
                ...
                >
                    ...
                    <ul className="space-y-4 text-gray-300 ml-8">
                        <li className="flex items-start">
                            <span className="text-orange-500 mr-2">•</span>
                            Thanh toán được thực hiện thông qua các cổng thanh toán trực tuyến được hệ thống h��� trợ.
                        </li>
                        <li className="flex items-start">
                            <span className="text-orange-500 mr-2">•</span>
                ...
                >
                    ...
                    <ul className="space-y-4 text-gray-300 ml-8">
                        <li className="flex items-start">
                            <span className="text-orange-500 mr-2">•</span>
                            <span>
                                Quý khách <span className="text-yellow-500 font-semibold">phải từ 18 tuổi trở lên</span> để sử dụng dịch vụ đặt bàn.
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-orange-500 mr-2">•</span>
                            ...
                            <div className="text-gray-300 space-y-3">
                                ...
                                <ul className="space-y-2">
                                    <li className="flex items-center">
                                        <span className="text-orange-500 mr-2">•</span>
                                        <span className="text-yellow-500 font-semibold">Uống có trách nhiệm</span>
                                    </li>
                                    <li className="flex items-center">
                                        <span className="text-orange-500 mr-2">•</span>
                                        <span className="text-yellow-500 font-semibold">Không lái xe khi đã sử dụng đồ uống có cồn</span>
                                    </li>
                                    <li className="flex items-center">
                                        <span className="text-orange-500 mr-2">•</span>
                                        <span>Tuân thủ quy định về <span className="text-yellow-500 font-semibold">độ tuổi sử dụng đồ uống có cồn</span></span>
                                    </li>
                                </ul>
