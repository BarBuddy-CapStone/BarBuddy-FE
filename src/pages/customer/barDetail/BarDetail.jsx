                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-400">
                      ...
                      <span>•</span>
                      <time>
                        {new Date(feedback.createdTime).toLocaleDateString(
                          "vi-VN",
                          {
                            year: "numeric",
                            month: "long",
...
const DrinkCard = React.memo(({ images, drinkName, price, drinkId }) => {
  ...
  return (
    <div className="flex flex-col w-[calc(25%-0.75rem)] min-w-[200px] transition-transform transform hover:scale-105">
      <div className="flex flex-col grow items-center w-full text-center rounded-xl bg-neutral-700 p-3">
        <img
          loading="lazy"
          src={images}
          alt={drinkName}
          className="object-contain w-full h-36 rounded-md"
        />
        <div className="flex flex-col justify-between h-[60px] w-full">
          <button
            onClick={drinkDetailHandle}
            className="w-full"
            title={drinkName}
          >
            <h3 className="mt-2 text-sm leading-6 text-zinc-100 hover:text-amber-400 truncate">
              {drinkName}
            </h3>
          </button>
  ...
  return (
    <section className="w-full rounded-lg flex flex-col">
      <header className="flex flex-wrap gap-3 justify-between w-full leading-snug">
        <h2 className="text-xl text-amber-400">Đồ uống tại chi nhánh</h2>
      </header>
            ...
            {hasMoreDrinks && (
              <div className="flex justify-center mt-4 mb-2">
                <button
                  ...
                  className="px-4 py-1.5 bg-yellow-500 text-gray-800 rounded-lg hover:bg-yellow-600 transition-colors duration-300 font-semibold text-sm"
                >
                  Xem thêm
                </button>
              </div>
...
const BarDetail = () => {
  ...
  const sortedBarTimeResponses = barDetails?.barTimeResponses.sort(
  ...
  return (
    <div className="container mx-auto p-4 max-w-[1440px]">
              ...
              <div className="bg-neutral-800 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-gray-300">
                    <span className="w-8 h-8 flex items-center justify-center bg-neutral-700 rounded-full mr-3">
                      🎵
                    </span>
                    Âm nhạc sôi động
                  </div>
      ...
      {/* Reviews Section */}
      <div
        className="bg-neutral-800 text-white p-6 rounded-lg shadow-lg"
        id="reviews-section"
      >
        <div className="max-w-3xl mx-auto">
          {" "}
          {/* Thêm container giới hạn chiều rộng và căn giữa */}
          <h2 className="text-2xl text-yellow-500 font-bold mb-6 text-center">
