...
const FilterOption = ({ label }) => (
  <div className="flex overflow-hidden gap-6 items-start py-0.5 bg-neutral-700">
    <div className="flex shrink-0 rounded-full bg-zinc-300 h-[22px] w-[25px]" />
    <div>{label}</div>
  </div>
);
...
const Filter = () => {
  return (
    <div className="flex flex-col px-4 lg:px-8 py-6 w-full text-amber-400 rounded-md bg-neutral-800 shadow-[0px_0px_16px_rgba(0,0,0,0.07)]">
